...
ecom_router = APIRouter(tags=["ecom"])

security = HTTPBearer()


@ecom_router.post(
    "/webhook/courier/ecom/track-order",
    status_code=http.HTTPStatus.CREATED,
    response_model=GenericResponseModel,
)
async def tracking_webhook(request: Request):

    # print("halelelelelelelelelel")
    ...
    response: GenericResponseModel = Ecom.tracking_webhook(track_req=track_req)
