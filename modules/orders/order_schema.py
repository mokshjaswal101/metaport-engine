...
class Order_Base_Model(Order_create_request_model):
    ...
    pickup_completion_date: Optional[datetime]
    first_ofp_date: Optional[datetime]

    shipped_date: Optional[datetime]

    edd: Optional[datetime]

    first_ofd_date: Optional[datetime]
    delivered_date: Optional[datetime]

    rto_initiated_date: Optional[datetime]
    rto_delivered_date: Optional[datetime]
...
class DimensionUpdateModel(BaseModel):
    order_id: str  # Now supports values like "005_1"
    length: float
    breadth: float
    height: float
    dead_weight: float
